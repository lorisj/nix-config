...
let
  defaultKeys = [
    ...
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIL2RTDsJaDSTq7YFlz21IgLUUcJzuQejfkNjDAcp7YWE"
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIMrSmI3BrKrOR9r402C+ka+91lC5bHu5UuJaLZGR3UoZ"
  ];
in
{
